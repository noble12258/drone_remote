...
#define RF24L01_SET_CE_HIGH()      GPIO_SetBits(SI24R1_CE_PORT, SI24R1_CE_PIN)

//SPI片选信号	
#define RF24L01_SET_CS_LOW()     GPIO_ResetBits(SI24R1_CSN_PORT, SI24R1_CSN_PIN)
#define RF24L01_SET_CS_HIGH()     GPIO_SetBits(SI24R1_CSN_PORT, SI24R1_CSN_PIN)

#define RF24L01_GET_IRQ_STATUS()    GPIO_ReadInputDataBit(SI24R1_IRQ_PORT,SI24R1_IRQ_PIN)
//#define RF24L01_GET_IRQ_STATUS()		(( SI24R1_IRQ_PORT->IDR & (uint32_t)SI24R1_IRQ_PIN) != SI24R1_IRQ_PIN ) ? 0 : 1	//IRQ状态
//NRF24L01发送接收数据宽度定义
#define TX_ADR_WIDTH    5		//5字节的地址宽度
#define RX_ADR_WIDTH    5		//5字节的地址宽度

#if FOUR_AXIS_UAV
#define TX_PLOAD_WIDTH  11		//最多32字节的用户数据宽度
#define RX_PLOAD_WIDTH  20		//最多32字节的用户数据宽度
#elif FIXED_WING_AIRCRAFT
#define TX_PLOAD_WIDTH  11		//最多32字节的用户数据宽度
#define RX_PLOAD_WIDTH  11		//最多32字节的用户数据宽度
#elif BRUSHLESS_FOUR_AXIS_UAV
#define TX_PLOAD_WIDTH  14		//最多32字节的用户数据宽度
#define RX_PLOAD_WIDTH  14		//最多32字节的用户数据宽度
#endif
